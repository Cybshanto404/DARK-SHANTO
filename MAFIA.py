...
def cek_apk(session, coki):
    def get_apk_details(url, status, title):
        ...
        if len(game) == 0:
            ...
            print(f'\r{H}[✓]%sYour {title} Application Details :%s' % (H,H))
...
def api1(ids,names,passlist):
        try:
            ...
            for pw in passlist:
                ...
                li = ['28','29','210']
                uaua = f'Dalvik/2.1.0 (Linux; U; Android 13.0; Samsung Galaxy S21 Build/OPR1.8610) [FBAN/EMA;FBBV/{str(application_version_code)};FBAV/{str(application_version)};FBDV/Samsung Galaxy S21;FBLC/id_ID;FBNG/WIFI;FBMNT/METERED;FBDM/'+'{density=2.75,height=1440,width=720};]'
